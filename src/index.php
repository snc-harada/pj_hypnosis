...
<body id="pTop" class="website" data-responsejs='{"create":[{"prop":"width","prefix":"src","lazy":true,"breakpoints":[0,592,1001]}]}'>
    ...
    <main>
        ...
        <div class="first_view">
            <!-- <img src="./img/fv.webp" alt="リアル検証催眠術体験2025"> -->
            <h1 class="fade"><img src="./img/fv02.webp" alt="リアル検証催眠体験2025ー神戸三宮から徒歩10分！催眠術イベントが体験できる新感覚エンターテイメント！"></h1>
            <!-- <div class="badge">
        ...
        <div class="lp_con deco">
            <div class="inner">
                ...
                <section class="howtoplay" id="howtoplay">
                    <h2 class="itemdiv fade"><img src="./img/con01.webp" alt="プロの催眠師による催眠体験"></h2>
                    ...
                    <div class="link_area gomap itemdiv fade">
                    ...
                    <div class="itemdiv fade"><img src="./img/con02_03.webp" alt="03.受付に行く"></div>
        ...
        <section class="ticketarea base-con" id="ticket">
            ...
            <p class="come">※催眠術の特性上、ご本人の協力とリラックスが不可欠です。<br>そのため、催眠術に対して強い抵抗感や否定的な思いをお持ちの方は、ご体験をお控えいただきますようお願い申し上げます。</p>
            </div>

            <div class="attention_rule content_wrap fade">
                ...
                <ul class="ruleList">
                    ...
                    <li>・チケットは事前予約制ですが、定員に空きがある場合のみ当日券を販売いたします。当日券の有無については、受付にてご確認ください。</li>
                    <li>・当イベントは中学生以上のお客様が対象となるイベントです。小学生以下の方はご入場いただけませんのでご了承ください。（待機スペース等のご用意もございません）</li>
                    <li>・チケット販売画面で表示されている数が残りの参加枠になります。お連れ様がいらっしゃる場合は、必ず2枚以上のチケットが確保できることを確認してからご購入ください。</li>
                </ul>
            </div>
        </section>
        <section class="base-con" id="faq">
            ...
            <ul class="accordion-area fade">
                ...
                <li class="accarea-item">
                    <div class="acctitle">
                        <p class="txt">本当に催眠術にかかるんですか？</p>
                    </div>
                    <div class="accbox">
                        <ul class="ticketList">
                            <li class="list-item">
                                <p>本イベントは必ず催眠術をかけてもらえるというものではなくかかる、かからないを含めてお客様自身に体験してもらうものとなっております。<br>※催眠術に対して否定的なご意見をお持ちの方は、体験の効果が出にくいため、参加をご遠慮いただいております。</p>
                            </li>
                        </ul>
                    </div>
                </li>
        ...
        <section class="access base-con" id="access">
            ...
            <div class="content_wrap flex fade">
                <div class="txt">
                    <img src="./img/access_txt.webp?v=2" alt="兵庫県神戸市中央区小野柄通３丁目２−２３ 加藤三宮ビル">
                    <dl>
                        <dt>会場情報</dt>
                        <dd>
                            &#12306;651-0088<br>
                            兵庫県神戸市中央区小野柄通3-2-23&nbsp;加藤三宮ビル2F
                        </dd>
                    </dl>
                    <dl>
                        <dt>開催期間</dt>
